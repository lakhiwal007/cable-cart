...
const MachineDetails = () => {
  const { machineId, machineType } = useParams<{
    machineId: string;
    machineType: "sell" | "buy";
  }>();
...
${
  machine.main_motor_capacity
    ? `Main Motor Capacity: ${machine.main_motor_capacity}`
    : ""
}
${
  machine.line_speed_max_size
    ? `Line Speed Max Size: ${machine.line_speed_max_size}`
    : ""
}
${
  machine.expected_daily_production
    ? `Expected Daily Production: ${machine.expected_daily_production}`
    : ""
}
...
${
  machineType === "buy" && (machine as BuyMachine).notes
    ? `Notes: ${(machine as BuyMachine).notes}`
    : ""
}
`;
    ...
    a.href = url;
    a.download = `${machine.machine_name
      .replace(/[^a-z0-9]/gi, "_")
      .toLowerCase()}_details.txt`;
    a.click();
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span className="text-sm md:text-lg">
                  {machine.manufacturing_location}
                </span>
              </div>
            </div>
              ...
              <CardContent className="p-4">
                <div className="aspect-video max-w-xs mx-auto bg-gray-100 rounded-lg overflow-hidden">
                  {(() => {
                    ...
                    if (
                      isSell &&
                      sellMachine.production_image_urls &&
                      sellMachine.production_image_urls.length > 0
                    ) {
                              ...
                              {allMedia.map((mediaUrl, index) => (
                                <CarouselItem key={index}>
                                  {mediaUrl === sellMachine.video_url ? (
                                    ...
                                    <img
                                      src={mediaUrl}
                                      alt={`${machine.machine_name} - Image ${
                                        index + 1
                                      }`}
                      ...
                      const allMedia = [...buyMachine.production_image_urls];
              ...
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="specifications" className="space-y-4 mt-4">
                  <div className="space-y-4">
                    ...
                    {isSell &&
                      sellMachine.other_options &&
                      Object.values(sellMachine.other_options).some(
                        (option) => option
                      ) && (
                        <div>
                          <h4 className="font-semibold mb-2 text-sm md:text-base">
                          ...
                          <div className="space-y-2">
                            {Object.entries(sellMachine.other_options).map(
                              ([key, value], index) =>
                                value && (
                                  <p
                                    key={key}
                                    className="text-gray-700 bg-gray-50 p-3 rounded-lg text-sm md:text-base"
                                  >
                                    <span className="font-medium">
                                      Option {index + 1}:
                                    </span>{" "}
            ...
            <Card>
              ...
              <CardContent className="p-4 md:p-6 space-y-4">
                <div className="text-center">
                  ...
                  {(isSell
                    ? sellMachine.supplier.user_type
                    : buyMachine.buyer.user_type) && (
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs md:text-sm break-all">
                      {isSell
                        ? sellMachine.supplier.email
                        : buyMachine.buyer.email}
                    </span>
                  </div>
              ...
              <div className="p-4 bg-blue-50 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">
                      {isSell
                        ? sellMachine.supplier.name
                        : buyMachine.buyer.name}
                    </span>
                  </div>
